...
export const metadata: Metadata = {
  title: "上田 陣義 | JM GROUP - パーソナルトレーナー / 実業家",
  description:
  ...
  return (
    <html lang="ja" className="antialiased">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;1,400&family=Inter:wght@300;400;500;600;700&family=Noto+Sans+JP:wght@300;400;500;600;700&family=Noto+Serif+JP:wght@300;400;500;600&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
